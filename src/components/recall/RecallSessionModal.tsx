            ...
            <div className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-4">
              ...
              {(() => {
                const fragility = getDescriptiveFragileSubconcept(
                  session.topicName || topic?.canonicalName || 'Topic',
                  topic?.category || 'Data Science',
                ...
                return (
                  <div className="px-3.5 py-2.5 bg-stone-950/70 border border-stone-800 rounded-xl text-xs text-stone-300 flex items-center justify-between gap-3 shadow-xs">
                    <div className="flex items-center gap-2 min-w-0">
                      <span className="font-semibold text-stone-100 shrink-0 font-sans">{session.topicName}</span>
                      <span className="text-stone-600 shrink-0">·</span>
                      <span className="text-stone-400 truncate">
                        Focusing on: <strong className="text-amber-300 font-medium">{fragility.fragileSubconcept}</strong>
                      </span>
                    </div>
                    <span className="text-[10px] font-mono text-stone-500 shrink-0 capitalize hidden sm:inline">
